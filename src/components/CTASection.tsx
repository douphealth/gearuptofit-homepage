      ...
      <div className="container relative z-10 text-center">
        ...
        >
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tight font-display mb-6 leading-[0.95]">
            Make your next
            <span className="text-gradient-red block">fitness decision easier</span>
          </h2>

          <p className="text-lg md:text-xl text-muted-foreground font-body max-w-2xl mx-auto mb-10 leading-relaxed">
            Use GearUpToFit&apos;s free tools and evidence-aware guides to choose better shoes, compare gear,
            calculate realistic targets, and build a smarter plan.
          </p>
